# Dasein Foresight — ICPs (Ideal Customer Profiles)

> Perfiles de cliente ideal para venta operativa.
> Versión resumida para uso comercial, no manifiesto interno.

---

## ICP 1: Banca y Servicios Financieros

**Cargo target:** VP/Director de Innovación, Gerente de Riesgo, Gerente de Estrategia, CDO
...
## ICP 2: Minería y Energía

**Cargo target:** VP Estrategia, Director de Sostenibilidad, Gerente de Asuntos Corporativos
...
## ICP 3: Educación Superior

**Cargo target:** Vicerrector Académico, Director de Innovación Educativa, Decano
...
## ICP 4: Sector Público

**Cargo target:** Jefe de Innovación, Director de Planificación, Asesor de Gabinete
...
NO perseguir leads que:
- Solo quieren "una presentación de tendencias" sin decisión al frente
- Buscan implementación técnica directa (referir a partner)
- No tienen presupuesto confirmado ni proceso de compra claro
- Son startups tempranas o pymes < 50 personas
- Quieren "ver la herramienta" (no vendemos software)
- Necesitan resultado en < 3 días (no tenemos servicio express)
