...
import {createPosTargetShader, createAccShader, createVelShader, createPosShader} from './entangled-square-shaders.js';
...
function init() {
    console.log("Initializing Entangled Square...");
    initialized = true;
...
function setupGpuComputation() {
    ...
    console.log('GPU computation initialized - Square shape');
}
...
function setupInteraction() {
    ...
    document.getElementById('openPair').addEventListener('click', () => {
        ...
        window.open(
            'entangled-square.html',
            'entangled-square-pair',
