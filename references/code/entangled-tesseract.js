...
import {createPosTargetShader, createAccShader, createVelShader, createPosShader} from './entangled-tesseract-shaders.js';
...
function init() {
    console.log("Initializing Entangled Tesseract...");
    initialized = true;
...
function setupGpuComputation() {
    ...
    console.log('GPU computation initialized - Tesseract shape');
}
...
function setupInteraction() {
    ...
    document.getElementById('openPair').addEventListener('click', () => {
        ...
        window.open(
            'entangled-tesseract.html',
            'entangled-tesseract-pair',
